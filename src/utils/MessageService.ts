...
export class MessageService {
    ...
    readonly GET_ALL_BUSINESS_FETCH_SUCCESS = "All Businesses fetched successfully!";
    ...
    readonly PRODUCT_DELETE_NOT_ALLOWED = "You are not allowed to delete this product";

    readonly SERVICE_DELETE_SUCCESS = "Service deleted successfully";
    readonly SERVICE_DELETE_ERROR = "Error deleting service";
    readonly SERVICE_DELETE_NOT_ALLOWED = "You are not allowed to delete this service";
